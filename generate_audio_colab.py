...
# --- Voice ID: нативные голоса под каждый язык (не Zuzana/Marek напрямую —
#     ElevenLabs сохраняет акцент исходного голоса при смене языка, поэтому
#     для DE/ES взяты отдельные голоса из библиотеки, помеченные как German/Spanish) ---
VOICE_ID_BY_AVATAR_AND_COUNTRY = {
...
for country, url in SCENARIO_URLS.items():
    ...
    for scenario in data["scenarios"]:
        ...
        voice_id = VOICE_ID_BY_AVATAR_AND_COUNTRY[avatar][country]
